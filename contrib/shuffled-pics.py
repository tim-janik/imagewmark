...
- Ignore images with max dimension >= 4000
- Pick no more than 10 images with max dimension >= 3000
- Pick no more than 20 images with max dimension >= 2000
- Ignore images with min dimension < 512
